...
def save_to_csv(save_complicated_code_dir_pkl):
    ...
    #     print("each code: ",e)
    util.save_csv(util.data_root_mv + "idiom_code_dir_star_1000_csv/multi_assign_idiom_code.csv",
                  result_compli_for_else_list[:1200], ["repo_name", "code1", "file_html", "file_path"])
...
'''
    ...
    save_complicated_code_dir_pkl = util.data_root_mv + "idiom_code_dir_pkl/multi_assign_idiom_code/"
    ...
    for repo_name in dict_repo_file_python:
        ...
        #     continue
        print("come to the repos: ", repo_name)
        if os.path.exists("/data/zejun/smp/data/python_star_2000repo/"+repo_name):
            continue
        print("come to the repo: ",repo_name)
        for file_info in dict_repo_file_python[repo_name]:
            file_path = file_info["file_path"]
