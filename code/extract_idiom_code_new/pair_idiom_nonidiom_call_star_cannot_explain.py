...
def save_to_csv(save_complicated_code_dir_pkl):
    ...
    for file_name in sorted(os.listdir(save_complicated_code_dir_pkl)):
        ...
        for file_html in complicate_code:
            # if file_html!="https://github.com/nesdis/djongo/tree/master/tests/django_tests/tests/v22/tests/utils_tests/test_datetime_safe.py":
            #     continue
                ...
                for me in complicate_code[file_html][cl]:
                    if complicate_code[file_html][cl][me]:
                        for code in complicate_code[file_html][cl][me]:
                            ...
                            if len(code[1])>3:
                                result_compli_for_else_list.append(
                                    [repo_name, file_html, cl, me, ast.unparse(code[0]),
                                     "\n".join([code[1][3][1],code[1][1], code[1][0], code[1][2]]), code[2], code[3]
                                     ])
                            else:
                                result_compli_for_else_list.append(
                                    [repo_name, file_html, cl, me, ast.unparse(code[0]),
                            ...
                            # print("result_compli_for_else_list: ",result_compli_for_else_list)
        #     break
        # break
