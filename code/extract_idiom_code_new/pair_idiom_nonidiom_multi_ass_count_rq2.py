...
def save_to_csv(save_complicated_code_dir_pkl):
                ...
                for me in complicate_code[file_html][cl]:
                    if complicate_code[file_html][cl][me]:
                        for code in complicate_code[file_html][cl][me]:
                            ...
                            result_compli_for_else_list.append(
                                [repo_name, file_html, cl, me, ast.unparse(simple_code),
    ...
    #     print("each code: ",e)
    util.save_pkl(util.data_root + "idiom_code_dir_star_1000_csv/", "multi_assign_idiom_code_shuffle_rq2",
                  result_compli_for_else_list)
    random.seed(2023)
    random.shuffle(result_compli_for_else_list)
    util.save_csv(util.data_root+"idiom_code_dir_star_1000_csv/multi_assign_idiom_code_shuffle_rq2.csv",result_compli_for_else_list[:],["repo_name","file_html","cl","me","simple_code",
                                 "cmplete_code","count_tmp","count_targets","count_star_total","count_tmp_func"])
...
'''
    ...
    save_complicated_code_dir_pkl= util.data_root + "idiom_code_dir_pkl_new/multi_assign_idiom_code_new_rq_2/"
