...
def save_to_csv(save_complicated_code_dir_pkl):
                        ...
                        for code in complicate_code[file_html][cl][me]:
                            ...
                            result_compli_for_else_list.append(
                                [repo_name, file_html, cl, me, ast.unparse(code[0]),
                                 "\n".join([code[1][1], code[1][0], code[1][2]]),code[2],code[3]
                                 ])
        #     break
        # break
    ...
    print("len: ",len(result_compli_for_else_list))
    print("number of repos: ",len(repo_name_list),len(set(repo_name_list)))
    util.save_csv(util.data_root+"idiom_code_dir_star_1000_csv/star_call_idiom_code.csv",result_compli_for_else_list,["repo_name","file_html","file_path","complicate_code","call_func","simple_code","if_refactorable"])
...
def parse_a_tree(tree):
    ...
    for code in old_code_list:
        code_list.append(transform_idiom_call_star(code[0],code[1],code[2]))
    print(code_list)
    return code_list
def save_repo_for_else_complicated(repo_name):
    ...
    for file_info in dict_repo_file_python[repo_name]:
        ...
        # if file_html!="https://github.com/sympy/sympy/tree/master/sympy/tensor/indexed.py":#"https://github.com/3b1b/videos/tree/master/_2017/tattoo.py":#"https://github.com/pimutils/khal/tree/master/doc/source/conf.py":
        #     continue
        print("come this file: ", file_html,file_path)
        try:
        ...
        try:
            ...
            for tree, class_name in ana_py.func_def_list:
                ...
                for code in old_code_list:
                    ...
                    if each_code_pair and each_code_pair[-1]:
...
func_a(*a[:2])
func_a(*a[:len(kav)])
reverse_func(*tensors[::-1], **kw) *tensors[::-1]
func(*a[-1:-3:-1])#2
func(*a[3:1:-1])# 2
func(*a[3::-1])# 4
func(*a[i+2:i:-1])
...
'''
    ...
    for repo_name in dict_repo_file_python:
        # if repo_name!="sympy":#"3d-photo-inpainting":#anki
        #     continue
    ...
    '''
    come this file:  https://github.com/laike9m/Cyberbrain/tree/master/test/test_exception.py /data1/zhangzejun/mnt/zejun/smp/data/python_star_2000repo/Cyberbrain/test/test_exception.py
old str:  f(*1, *2) *1
value:  <ast.Constant object at 0x7f204261b7f0>
    '''
    '''
