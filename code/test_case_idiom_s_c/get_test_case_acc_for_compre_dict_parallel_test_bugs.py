    ...
    for file in os.listdir(save_acc_res_csv_dir):
        ...
        for repo_name, file_html,cl, me, old_code, new_code,flag_pass, test_html_list in complicate_code:
            ...
            if not int(flag_pass):
                    ...
                    print("repo_name, file_html,cl, me, old_code, new_code: ", repo_name, file_html, cl, me, old_code,
                          new_code)
            #         break
            # else:
            #     continue
            ...
            # break
    util.save_csv(save_failed_res_csv_dir + "failed_dict_comprehension.csv",
                      failed_res,
                      ["repo_name", "file_html", "cl", "me", "old_code", "new_code", "flag_pass", "test_html_list"])
...
if __name__ == '__main__':
    ...
    save_acc_res_csv_dir = util.data_root + "idiom_acc_res_compli_test_case_csv_new/for_compre_dict/"
    ...
    save_test_acc_dir = util.data_root + "idiom_test_case_benchmark_dir_new/for_compre_dict_acc_dir/"

    save_failed_res_csv_dir = util.data_root + "idiom_failed_testcases_dir/for_compre_dict_acc_dir/"
    ...
    for ind,file in enumerate(os.listdir(save_test_file_res_dir)):
        ...
        repo_list.append(file)
        file="networkx.pkl"#"dynaconf.pkl"#"zdict.pkl"#"powerline.pkl"#"parallel-ssh.pkl"#"Axelrod.pkl"#"finta.pkl"#"pattern.pkl"#"kafka-python"#"python-slack-sdk.pkl"#"business-rules.pkl"
        # file="borgmatic.pkl"
        # get_each_repo_test_acc(file)
        break
        # if ind>=1:
