...
def get_test_case_failed(save_acc_res_csv_dir):
    ...
    for file in os.listdir(save_acc_res_csv_dir):
        ...
        # break
    util.save_csv(save_failed_res_csv_dir + "failed_truth_value_test_new_2.csv",
                      failed_res,
                      ["repo_name", "file_html", "cl", "me", "old_code", "new_code", "flag_pass", "test_html_list"])
...
if __name__ == '__main__':
    ...
    save_me_test_me_dir= util.data_root + "idiom_methods_test_method_pair/for_else/"
    ...
    save_test_file_res_dir=util.data_root + "idiom_save_test_file_res_dir/truth_value_test/"
    save_test_file_res_dir=util.data_root + "idiom_save_test_file_res_dir/for_else/"
    ...
    complicated_code_dir_pkl = util.data_root + "idiom_code_dir_pkl_new/for_else_idiom_code/"
    ...
    save_acc_res_csv_dir = util.data_root + "idiom_acc_res_compli_test_case_csv_new/for_else/"
    ...
    save_test_acc_dir = util.data_root + "idiom_test_case_benchmark_dir_new/for_else/"
