...
if __name__ == '__main__':
    ...
    for file_name in os.listdir(save_me_test_me_dir):
        ...
        repos_test_me_code.append(repo_name)
    print("intersect repos: ",len(set(repos_test_case)),len(set(repos_test_me_code)),len(set(repos_test_case)&set(repos_test_me_code)))
    # '''
