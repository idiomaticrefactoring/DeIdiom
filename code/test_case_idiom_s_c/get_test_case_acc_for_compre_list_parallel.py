...
def get_test_case_failed(save_acc_res_csv_dir):
    ...
    for file in os.listdir(save_acc_res_csv_dir):
        ...
        # break
    util.save_csv(save_failed_res_csv_dir + "failed_list_comprehension.csv",
                  failed_res,
                  ["repo_name", "file_html", "cl", "me", "old_code", "new_code", "flag_pass", "test_html_list"])
...
if __name__ == '__main__':
    ...
    save_acc_res_csv_dir = util.data_root + "idiom_acc_res_compli_test_case_csv_new/for_compre_list/"
    ...
    save_test_acc_dir = util.data_root + "idiom_test_case_benchmark_dir_new/for_compre_list_acc_dir/"
