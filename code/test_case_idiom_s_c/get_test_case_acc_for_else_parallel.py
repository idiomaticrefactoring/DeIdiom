...
def get_each_repo_test_acc(file):
    ...
    #                         else:
        ...
        #             break
        #         else:
        #             cget_test_case_acc_for_else_parallel.pyontinue
        #         break
...
def get_test_case_failed(save_acc_res_csv_dir):
    ...
    for file in os.listdir(save_acc_res_csv_dir):
        ...
        # break
    util.save_csv(save_failed_res_csv_dir + "failed_for_else.csv",
                  failed_res,
                  ["repo_name", "file_html", "cl", "me", "old_code", "new_code", "flag_pass", "test_html_list"])
...
if __name__ == '__main__':
    ...
    save_acc_res_csv_dir = util.data_root + "idiom_acc_res_compli_test_case_csv/for_else/"
    ...
    save_test_acc_dir = util.data_root + "idiom_test_case_benchmark_dir/for_else/"
    ...
    # geget_test_case_acc_for_else_parallel.pyt_test_case_failed(save_acc_res_csv_dir)
    # '''
    time_end = time.time()
