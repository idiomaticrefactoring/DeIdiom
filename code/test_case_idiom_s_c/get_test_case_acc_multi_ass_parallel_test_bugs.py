...
def get_test_case_failed(save_acc_res_csv_dir):
    ...
    for file in os.listdir(save_acc_res_csv_dir):
        ...
        # break
    util.save_csv(save_failed_res_csv_dir + "failed_multi_assign_tmp_chain_ass_var_depend.csv",
                      failed_res,
                      ["repo_name", "file_html", "cl", "me", "old_code", "new_code", "flag_pass", "test_html_list"])
...
if __name__ == '__main__':
    ...
    complicated_code_dir_pkl= util.data_root + "idiom_code_dir_pkl_new/multi_assign_idiom_code/"
    complicated_code_dir_pkl= util.data_root + "idiom_code_dir_pkl_new/multi_assign_idiom_code_new/"
    ...
    save_acc_res_csv_dir = util.data_root + "idiom_acc_res_compli_test_case_csv/multi_assign/"
    save_acc_res_csv_dir = util.data_root + "idiom_acc_res_compli_test_case_csv/multi_assign_tmp_chain_ass_var_depend/"
    save_acc_res_csv_dir = util.data_root + "idiom_acc_res_compli_test_case_csv/multi_assign_tmp_chain_ass_var_depend_new/"
    ...
    save_test_acc_dir = util.data_root + "idiom_test_case_benchmark_dir/multi_assign/"
    save_test_acc_dir = util.data_root + "idiom_test_case_benchmark_dir/multi_assign_tmp_chain_ass_var_depend/"
    save_test_acc_dir = util.data_root + "idiom_test_case_benchmark_dir/multi_assign_tmp_chain_ass_var_depend_new/"
    ...
    for ind,file in enumerate(os.listdir(save_test_file_res_dir)):
        ...
        repo_list.append(file)
        file="pydantic.pkl"#"""networkx.pkl"#"nibabel.pkl"#"pydantic.pkl"#"pony.pkl"#"nibabel.pkl"#"pyannotate.pkl"#"gallery-dl.pkl"#"yt-dlp.pkl"#"profiling.pkl"#"feature_engine.pkl"#"gunicorn.pkl"#"DataProfiler.pkl"#"pyexcel.pkl"#"borgmatic.pkl"#"profiling.pkl"#"nox.pkl"#"feature_engine.pkl"#"nameko.pkl"#"NeuroKit.pkl"#"BERT-Classification-Tutorial.pkl"#"heatmap.pkl"#"category_encoders.pkl"#"feature_engine.pkl"#"covid_19.pkl"#"gunicorn.pkl"#"troposphere.pkl"#"gns3-server.pkl"#"mido.pkl"#"asv.pkl"#"dynaconf.pkl"#"zdict.pkl"#"powerline.pkl"#"parallel-ssh.pkl"#"Axelrod.pkl"#"finta.pkl"#"pattern.pkl"#"kafka-python"#"python-slack-sdk.pkl"#"business-rules.pkl"
        # file="borgmatic.pkl"
        get_each_repo_test_acc(file)
        break
        # if ind>=1:
