...
if __name__ == '__main__':
    ...
    for ind,file in enumerate(os.listdir(save_test_file_res_dir)):
        ...
        repo_list.append(file)
        file="pattern.pkl"#"patternsimpleai.pkl.pkl"#"TensorNetwork.pkl"#"proselint.pkl"#"errbot.pkl"#"simpleai.pkl"#"powerline.pkl"#"parallel-ssh.pkl"#"Axelrod.pkl"#"finta.pkl"#"pattern.pkl"#"kafka-python"#"python-slack-sdk.pkl"#"business-rules.pkl"
        # file="borgmatic.pkl"
        get_each_repo_test_acc(file)
        break
        # if ind>=1:
