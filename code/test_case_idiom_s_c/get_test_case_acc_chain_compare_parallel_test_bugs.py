...
def get_test_acc(save_test_acc_dir):
    ...
    print("repo_count,file_count,me_count,complic_code_count,total_tcs:", repo_count, file_count, me_count,
          complic_code_count, len(total_tcs), len(set(total_tcs)))
...
if __name__ == '__main__':
    ...
    for ind,file in enumerate(os.listdir(save_test_file_res_dir)):
        ...
        repo_list.append(file)
        file="troposphere.pkl"#"gns3-server.pkl"#"mido.pkl"#"asv.pkl"#"dynaconf.pkl"#"zdict.pkl"#"powerline.pkl"#"parallel-ssh.pkl"#"Axelrod.pkl"#"finta.pkl"#"pattern.pkl"#"kafka-python"#"python-slack-sdk.pkl"#"business-rules.pkl"
        # file="borgmatic.pkl"
        # get_each_repo_test_acc(file)
        break
        # if ind>=1:
