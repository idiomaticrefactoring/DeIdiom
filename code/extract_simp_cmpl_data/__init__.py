...
def save_repo_for_else_complicated(repo_name):
    ...
    for file_info in dict_repo_file_python[repo_name]:
        ...
        try:
            ...
            # if not content:
            #     print(file_html)
            one_file_chained_comparison_code_list = get_chained_comparison_test(content)
...
'''
    ...
    util.save_csv(util.data_root + "complicated_code_dir/truth_value_test_complicated.csv", result_compli_for_else_list,
